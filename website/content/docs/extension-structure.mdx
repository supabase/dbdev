...
description: Understand the files and structure required for a valid PostgreSQL trusted language extension
---
...
- default\_version (string). The version to use if the user doesn't provide one in the `create extension` command.
